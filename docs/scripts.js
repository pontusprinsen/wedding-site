...
const translations = {
    ...
    sv: {
        ...
        wedding: {
            ...
            welcome: 'Varmt välkomna att fira vår kärlek tillsammans med oss. Vi ser fram emot att dela denna för oss speciella dag med er.',
            details: 'Vi bjuder in till bröllop lördagen den 13 juni 2026 kl. 15:00 vid Kuorasjärven kartano. Vänligen anländ minst 15 minuter innan ceremonins början. Efter ceremonin fortsätter firandet på samma plats med mat, dryck och dans. Vänligen notera att enligt vår preliminära tidsplan inleds middagen kl. 17:00.',
            ...
            travelHotels: 'Nedan hittar du rekommenderade hotell i Seinäjoki. Alla föreslagna hotell befinner sig i närheten av järnvägsstationen. Vi rekommenderar att boka boende i god tid.',
        ...
        wedding: {
            ...
            travelHotels: 'Alta löydät suositeltuja hotelleja Seinäjoella lähellä rautatieasemaa. Suosittelemme varaamaan majoituksen ajoissa.',
        ...
        rsvp: {
            pageTitle: 'Vastauslomake',
            submit: 'Lähetä vastaus',
            thankYouTitle: 'Kiitos!',
            thankYouText: 'Vastaus on lähetetty. Voit päivittää sen milloin tahansa.',
