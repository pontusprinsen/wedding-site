...
const translations = {
    ...
    sv: {
        ...
        wedding: {
            ...
            gift: 'Som bröllopsgåva önskar vi gärna ett bidrag till vår smekmånad. Vill du ge en gåva kan den sättas in på följande konto:<br/>IBAN: FI53 3939 0038 8658 12<br/>Mottagare: Hanna Koskela<br/>Tack för ert bidrag som hjälper oss skapa oförglömliga minnen tillsammans!',
            ...
            travelBus: 'Buss till och från Seinäjoki ordnas. Vänligen ange ert behov av transport i anmälningsformuläret.',
